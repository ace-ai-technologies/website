    ...
    sections: [
      {
        ...
        features: [
          ...
          },
          {
            ...
            plans: ["10MB", "Unlimited", "Unlimited", "Unlimited"],
          },
          {
            name: "Issues (excluding Archive)",
            plans: ["250", "Unlimited", "Unlimited", "Unlimited"],
          },
      ...
      },
      {
        ...
        features: [
          {
            name: "Issues, projects, cycles, and initiatives",
      ...
      },
      {
        ...
        features: [
          {
            name: "SSO",
            plans: ["G Suite", "G Suite", "G Suite", "G Suite + SAML"],
          },
    ...
    <div className="bg-black text-white py-16 px-4 lg:px-24">
      ...
      <div className="text-center mb-12 mt-20">
        ...
        <p className="text-lg mt-4 text-gray-500 max-w-2xl mx-auto">
          Tens of thousands of companies use our product to build better. From
          next-gen startups to established enterprises.
        </p>
      </div>
      ...
      <div className="overflow-hidden mt-16">
        <div className="flex animate-scroll">
          {companies.concat(companies).map((company, index) => (
            <div key={index} className="mx-4 flex-shrink-0 relative w-24 h-12">
              <Image
                src={company.logo}
                alt={company.name}
                fill
        ...
        {pricingComparison.sections.map((section, sectionIndex) => (
          <div key={sectionIndex} className="mt-8">
            ...
            {section.features.map((feature, featureIndex) => (
              <div
                key={featureIndex}
                className="grid grid-cols-5 gap-4 py-2 border-t border-gray-800"
              >
